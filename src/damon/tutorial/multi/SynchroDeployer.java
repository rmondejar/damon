...
public class SynchroDeployer {
  ...
  public static void main (String[] args) {
	  try {
	    ...
	    storage.deploy("damon.tutorial.multi.Synchro");
	    
	    long t1 = System.currentTimeMillis();

	    control.activate("damon.tutorial.multi.Synchro");
	    ...
	    System.in.read();
	    control.passivate("damon.tutorial.multi.Synchro");
