...
public class SimpleDeployer {
  ...
  public static void main (String[] args) {
	  try {
	    ...
	    storage.deploy("damon.tutorial.metapointcut.Simple");
	    storage.deploy("damon.tutorial.metapointcut.SimpleLog");
	    
	    long t1 = System.currentTimeMillis();

	    control.activate("damon.tutorial.metapointcut.Simple");
	    control.activate("damon.tutorial.metapointcut.SimpleLog");
	    ...
	    control.passivate("damon.tutorial.metapointcut.Simple");
	    control.passivate("damon.tutorial.metapointcut.SimpleLog");
