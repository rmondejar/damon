...
/**
 * Source Hook definition for TimeHost
 * @author Rubén Mondéjar <ruben.mondejar@urv.cat>
 */
public class SourceHooks {
		
	@Before("execution(* damon.tutorial.redirect.TimeHost.getHost(..))")          
	public void getHost(JoinPoint joinPoint) {
		thisEndPoint.addParams(joinPoint);
	}
